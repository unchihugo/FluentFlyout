...
<p align="center">
  <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.md">English</a> | <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.zh.md">简体中文</a> | <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.nl.md">Nederlands</a> | <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.fr.md">Français</a> | <strong>Türkçe</strong> | <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.ru.md">Русский</a> | <a href="https://github.com/unchihugo/FluentFlyout/blob/master/README.kr.md">한국어</a>
</p>
...
- Açık ve Koyu modu destekler
- Cihazınızın renk temasıyla eşleşir
- Akıcı animasyonlar
- Özelleştirilebilir flyout konumları
- Tümünü Tekrarla, Birini Tekrarla ve Karıştırma seçeneklerini içerir
- Sistem tepsisinde rahatsız etmeyecek şekilde yer alır
...
<p align="center">
  <em>“Windows 11, bir tane daha vazgeçilmez uygulama kazanmış olabilir.”</em> — <strong><a href="https://www.windowscentral.com/microsoft/windows-11/microsoft-is-too-busy-with-ai-to-fix-windows-11s-design-so-developers-stepped-up">Windows Central</a></strong><br>
  <em>“Microsoft’un resmi olarak sunduğundan daha iyi bir iş çıkarıyor.”</em> — <strong><a href="https://www.neowin.net/news/this-free-unofficial-app-promises-big-list-of-modern-windows-11-fluent-customization-options/">Neowin</a></strong>
</p>

## Görev çubuğu bileşeni ⏯️
<div align="center">
	<img height="440px" width="auto" src="https://github.com/user-attachments/assets/43963c54-e2d8-4b93-9842-482e12b2c592" />
</div>

<details close>
<summary>Video tanıtımı</summary>
	
https://github.com/user-attachments/assets/bfc7666f-1d59-4cbf-8d15-3855671cb147

</details>

## Flyout’lar ve daha fazlası 🎵
<div align="center">
...
<details open>
<summary>v2.0 ekran görüntüleri</summary>
<div align="center">
...
- **Microsoft Store sürümü:** Arka planda otomatik güncellemeler ve tek tıkla kurulum sağlar. Geliştirmeyi finanse etmeye yardımcı olmak için tek seferlik satın almayla açılan küçük bir özellik seti sunar.
- **GitHub sürümü:** Tamamen ücretsiz, tüm özellikleri içerir ve açık kaynaklıdır. Tek dezavantajı, kurulum ve güncellemelerin manuel yapılmasıdır.

Desteğiniz ve anlayışınız için teşekkürler!

## Katkıda Bulunanlar 🙌
- [Hugo Li](https://unchihugo.github.io) – Orijinal Geliştirici, Microsoft Store Yayıncısı, CN & NL Çevirileri
- [LiAuTraver](https://github.com/LiAuTraver) – Kod Katkıcısı (uygulama tema değiştirici)
